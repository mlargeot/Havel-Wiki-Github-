...
- complexe challenge integration with network based challenges,
...
- a **powerful orchestration system** supporting containers VMs and networks,  
...
| **Hosting and Orchestration** | Deploy and manage isolated Docker containers, virtual machines or network per challenge. These features will be provided via Proxmox, Kubernetes for the virtual machine, docker and network management. |
...
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Active technology watch**        | Continuous research and documentation of orchestration, virtualization, networking technologies and other CTF platform (Docker, Proxmox, Kubernetes, WireGuard, CTFd...). |
...
| **Objectif complémentaire : Performance Optimization**   | Measured and optimized through benchmarks and load tests.           |
| **Objectif complémentaire : Collaboration with experts** | Validated via structured expert exchanges and applied improvements. |
